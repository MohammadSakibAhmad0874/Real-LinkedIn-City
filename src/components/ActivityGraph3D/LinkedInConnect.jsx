 ...
 * LinkedIn OAuth button added above the username input. All existing
 * layout, animations, and reviews are fully preserved.
 */
...
export function LinkedInConnect({ onConnect, loading, error, theme }) {
  ...
  const demos = ["mohammad-sakib-ahmad-743651351"];
  ...
  return (
    <div style={{
      ...
      {/* Creator badge */}
      <a href="https://github.com/MohammadSakibAhmad0874" target="_blank" rel="noopener noreferrer"
        style={{
      ...
      <div style={{
        ...
        <LinkedInAuthButton theme={theme} />

        {/* — or use username — separator */}
        <div style={{
          display: "flex", alignItems: "center", gap: "0.6rem",
          marginBottom: "1rem",
        }}>
          <div style={{ flex: 1, height: 1, background: `${theme.border}50` }} />
          <span style={{
            fontSize: "0.58rem", color: theme.muted,
            opacity: 0.6, letterSpacing: "0.08em",
          }}>or use username</span>
          <div style={{ flex: 1, height: 1, background: `${theme.border}50` }} />
        </div>
        ...
        <p style={{
          ...
          Real mode via LinkedIn sign-in · Demo mode always available · Session stored in secure cookie
        </p>
      </div>
      ...
      <div style={{
        ...
        <span>Developed by <span style={{ color: theme.accent, fontWeight: 700 }}>Mohammad Sakib Ahmad</span></span>
        <span>·</span>
        <a href="https://github.com/MohammadSakibAhmad0874" target="_blank" rel="noopener noreferrer"
        ...
        <span>·</span>
        <a href="https://www.linkedin.com/in/mohammad-sakib-ahmad-743651351" target="_blank" rel="noopener noreferrer"
          style={{ color: "inherit", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.25rem" }}
          onMouseEnter={e => e.currentTarget.style.color = theme.accent}
          onMouseLeave={e => e.currentTarget.style.color = "inherit"}
        >
