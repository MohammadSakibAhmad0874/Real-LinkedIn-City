 ...
 * Passes activeType to Building for per-type colour highlighting.
 */
...
export function IsometricGrid({
  sortedCells, stats, monthLabels, theme, mounted, hoveredDate, onHover, activeType,
}) {
      ...
      <g>
        {paintOrder.map(cell => {
          ...
          return (
            ...
            >
              <Building cell={cell} maxCount={stats.maxCount} theme={theme} hovered={isHov} activeType={activeType} />
            </g>
          );
        })}
      </g>
